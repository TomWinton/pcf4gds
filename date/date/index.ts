...
export class ctDateInputGds
  ...
  public init(
    ...
    this.value = (dateInput && dateInput.raw) || undefined;
...
//  const { value, onChange, disabled, required, hidden, inputMode , titleRef, attributeRef, hintRef, helptitleRef, helpmessageRef, hasFieldset} = props;
    ...
    ReactDOM.render(
      React.createElement(SP, {
        ...
        sendDate: (e: Date | null | undefined) => {
          console.log(e);
          this.value = e? e : undefined;
